          ...
          {toc?.map(tocItem => {
            ...
            return (
              <a
                ...
                className={`${activeSection === id && 'border-green-500 text-green-500 font-bold'} border-l pl-4 block hover:text-red-500 border-lduration-300 transform font-light dark:text-gray-300
